"""Build the field guide PDF for the v0.14.0 guest-photo test.
...
OUT = r"C:\Users\edwar\Projects\photobooth-app-ipad\docs\Photobooth-v0.14.0-Test-Guide.pdf"
...
def furniture(canvas, doc):
    ...
    canvas.drawString(MARGIN, 11 * mm,
                      "Photobooth v0.14.0-ipad  |  Guest photo delivery test")
...
A(Spacer(1, 4))
A(Paragraph(
    "Photobooth <b>v0.14.0-ipad</b> &nbsp;&middot;&nbsp; step by step, from "
...
A(table(
    ...
    [
        ...
        ["Version to quote",
         "<b>0.14.0-ipad</b>, shown at the foot of the left-hand rail. Please "
...
A(steps([
    "Download <b>photobooth-v0.14.0-win-x64.zip</b> from the release page and "
    ...
    "Look at the foot of the left-hand rail. It should read <b>0.14.0-ipad</b>. "
...
A(callout(
    ...
    "turning on guest photos will look completely correct in Settings and do "
...
A(table(
    ...
    [
        ["Settings shows no <b>Guests reach the booth at</b> at all",
        ...
        ["Scanning the join code does nothing whatsoever",
         "The network name in Settings does not match a network that is actually "
...
doc = BaseDocTemplate(
    ...
    title="Photobooth v0.14.0 - Guest photo delivery test guide",
    author="Photobooth",
