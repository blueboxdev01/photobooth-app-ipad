"""Build the field guide PDF for the v0.12.0 guest-photo test.
...
OUT = r"C:\Users\edwar\Projects\photobooth-app-ipad\docs\Photobooth-v0.12.0-Test-Guide.pdf"
...
def furniture(canvas, doc):
    ...
    canvas.drawString(MARGIN, 11 * mm,
                      "Photobooth v0.12.0-ipad  |  Guest photo delivery test")
...
A(Spacer(1, 4))
A(Paragraph(
    "Photobooth <b>v0.12.0-ipad</b> &nbsp;&middot;&nbsp; step by step, from "
...
A(table(
    ...
    [
        ...
        ["Version to quote",
         "<b>0.12.0-ipad</b>, shown at the foot of the left-hand rail. Please "
...
A(steps([
    "Download <b>photobooth-v0.12.0-win-x64.zip</b> from the release page and "
    ...
    "Look at the foot of the left-hand rail. It should read <b>0.12.0-ipad</b>. "
...
A(steps([
    ...
    "Back in <b>Setup</b>, confirm that section no longer says a restart is "
    "needed. It should now show addresses and a certificate fingerprint.",
], 5))
...
doc = BaseDocTemplate(
    ...
    title="Photobooth v0.12.0 - Guest photo delivery test guide",
    author="Photobooth",
